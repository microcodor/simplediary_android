package com.wxdroid.simplediary.ui.login.activity;
...
import com.wxdroid.simplediary.ui.common.BarManager;
import com.wxdroid.simplediary.ui.common.StatusBarUtils;
import com.wxdroid.simplediary.ui.login.fragment.discovery.DiscoverFragment;
import com.wxdroid.simplediary.ui.login.fragment.home.HomeFragment;
import com.wxdroid.simplediary.ui.login.fragment.message.MessageFragment;
import com.wxdroid.simplediary.ui.login.fragment.post.PostActivity;
...
import com.wxdroid.simplediary.ui.login.fragment.profile.ProfileFragment;
import com.wxdroid.simplediary.ui.login.fragment.task.TaskMainFragment;
...
public class MainActivity extends AppCompatActivity {
     ...
     * 任务fragment的标识
     */
    private static final String TASK_FRAGMENT = "task";
    /**
     * 发现fragment的标识
     */
    ...
    private void restoreFragment(Bundle savedInstanceState) {
        ...
        mTaskMainFragment = (TaskMainFragment) mFragmentManager.findFragmentByTag(TASK_FRAGMENT);
     ...
     * 切换到任务模块
     */
    private void showTaskMainFragment() {
        mMessageTab.setSelected(true);
        if (mTaskMainFragment == null) {
            mTaskMainFragment = new TaskMainFragment();
            mTransaction.add(R.id.contentLayout, mTaskMainFragment, TASK_FRAGMENT);
        } else {
            mTransaction.show(mTaskMainFragment);
        }
    }
    ...
    private void hideAllFragments(FragmentTransaction transaction) {
        ...
        if (mTaskMainFragment != null) {
            transaction.hide(mTaskMainFragment);
        }
