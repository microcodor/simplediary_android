...
import com.wxdroid.simplediary.mvp.presenter.imp.WeiBoArrowPresenterImp;
...
/**
 * Created by jinchun on 2015/12/29.
 */
public abstract class WeiboAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        if (holder instanceof OriginViewHolder) {
            ...
            if (mDatas.get(position).user != null) {
                ...
                //FillContent.fillWeiBoVideoCover(mDatas.get(position).text, mContext, ((OriginViewHolder) holder).video_cover);
            }
            //如果这条原创微博被删除
            else {
    ...
    public static class OriginViewHolder extends ViewHolder {
        ...
        public OriginViewHolder(View v) {
            ...
            video_cover = (ImageView) v.findViewById(R.id.video_cover_image);
        }
    }
