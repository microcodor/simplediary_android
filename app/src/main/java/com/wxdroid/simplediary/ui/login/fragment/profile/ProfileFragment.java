package com.wxdroid.simplediary.ui.login.fragment.profile;
...
import com.wxdroid.simplediary.mvp.presenter.imp.ProfileFragmentPresentImp;
...
import com.wxdroid.simplediary.ui.login.fragment.profile.favorites.FavoritiesActivity;
import com.wxdroid.simplediary.ui.login.fragment.profile.followers.FollowerActivity;
import com.wxdroid.simplediary.ui.login.fragment.profile.friends.FriendsActivity;
import com.wxdroid.simplediary.ui.login.fragment.profile.myphoto.MyPhotoActivity;
import com.wxdroid.simplediary.ui.login.fragment.profile.myweibo.MyWeiBoActivity;
import com.wxdroid.simplediary.ui.login.fragment.profile.record.TimerRecordActivity;
import com.wxdroid.simplediary.ui.login.fragment.profile.setting.SettingActivity;
import com.wxdroid.simplediary.widget.mdprogressbar.CircleProgressBar;
...
public class ProfileFragment extends Fragment implements ProfileFragmentView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRecord_layout = (RelativeLayout) mView.findViewById(R.id.record_layout);
    ...
    private void setUpListener() {
        ...
        //定时记录跳转
        mRecord_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mActivity, TimerRecordActivity.class);
                startActivity(intent);
            }
        });
    }
