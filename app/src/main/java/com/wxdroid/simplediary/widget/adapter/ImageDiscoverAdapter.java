 ...
 */
public class ImageDiscoverAdapter extends RecyclerView.Adapter<ImageDiscoverAdapter.ViewHolder> {
    ...
    public ImageDiscoverAdapter(SimpleDiscoverModel model,ArrayList<String> imagelist, Context context) {
    ...
    public ImageDiscoverAdapter(SimpleDiscoverModel model,ArrayList<String> imagelist, boolean canClick, Context context) {
        this.simpleDiscoverModel = model;
        this.mData = imagelist;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        FillContent.fillDiscoverImageList(mContext, mData, options, position, holder.longImg, holder.norImg, holder.gifImg,
                holder.imageLabel,mSingleImageSize,mDoubleImgSize,mThreeImgSize, canClick);
    }
